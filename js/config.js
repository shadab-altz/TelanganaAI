...
const getMonthlySpeciesSightingForRangeURL = 'http://' + server + ':' + port + '/getMonthlySpeciesSightingForRange';
const getMonthlySpeciesSightingForRangeAndSectionURL = 'http://' + server + ':' + port + '/getMonthlySpeciesSightingForRangeAndSection';
